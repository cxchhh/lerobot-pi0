...
torchrun \
  ...
  --dataset.repo_id=lerobot/example_repo_absoluteqpos_filter_2 \
  --dataset.root=/mnt/kpfs/danshili/Workspace/lerobot/storage/data/lerobot/example_repo_absoluteqpos_filter_2 \
  --wandb.enable=true \
