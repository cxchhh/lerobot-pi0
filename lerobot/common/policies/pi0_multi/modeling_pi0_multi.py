...
class PI0MultiPolicy(PreTrainedPolicy):
    """Wrapper class around PI0FlowMatching model to train and run inference within LeRobot with multi-frame support."""

    config_class = PI0MultiConfig
    name = "pi0_multi"
