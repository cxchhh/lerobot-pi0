...
torchrun \
  ...
  --dataset.repo_id=lerobot/teleop-v1.0-PickNaiLong-InitTop \
  --dataset.root=/mnt/kpfs/danshili/Workspace/lerobot/storage/data/lerobot/teleop-v1.0-PickNaiLong-InitTop \
  --wandb.enable=true \
